...
while loop == 1:
    ...
    if lookup == "QOS" or "qos" or "quality of service":
        ...
        print(lookup)
        print('a method of keeping operating systems and applications routinely up to date for operational and security purposes')
        ...
        print(lookup)
        print('Developed by Ciso! Terminal Access Controller Access Control System (TACACS+) is a similar protocol to RADIUS but designed to be more flexible and reliable. TACACS+ is often used in authenticating administrative access to routers and switches.')
